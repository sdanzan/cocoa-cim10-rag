...
0.52 vs 0.40 and e2e any-hit 0.72 vs 0.60. See `../TECHNICAL.md` §5.
...
- Some calls are policy, not fact (how aggressively to abstain on isolated
  symptoms like *Fièvre*, *Désaturation*); revisit once prompt-level
  abstention is tuned (see `../TECHNICAL.md` §11). Note: a
  *retrieval-distance* cutoff can't help here — see `../TECHNICAL.md` §5,
  the signal doesn't separate abstain-worthy queries from answerable ones.
